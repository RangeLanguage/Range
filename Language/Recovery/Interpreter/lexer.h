/* Lexer for the Range recovery interpreter. Bootstrap-only.
 *
...
#ifndef RANGE_RECOVERY_LEXER_H
#define RANGE_RECOVERY_LEXER_H
...
typedef struct {
    ...
    int line;
    int column;
    /* Set when lexing fails; the interpreter reports and exits. */
    char error[512];
    int failed;
} RangeLexer;
